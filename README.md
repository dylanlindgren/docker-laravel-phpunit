...
This is a [Docker](http://www.docker.com) image for [PHPUnit](http://laravel.com/docs/artisan?), intended for use in the fashion described on my series of blog articles about using Docker and the [Laravel PHP framework](http://www.laravel.com) together:
...
An automated build for this repo is available on the [Docker Hub](https://registry.hub.docker.com/u/dylanlindgren/docker-laravel-phpunit).
